    ...
    <>
      ...
      <nav>
        ...
        <div className="nav-links">
          <Link href="/about" className="btn btn-ghost">Manifesto</Link>
      ...
      <section className="hero">
        <div className="hero-left">
          ...
          <p className="hero-sub">
            You built something <strong>wild with AI.</strong> A game, a site, a weird interactive thing. Now there's somewhere to put it — where builders <strong>watch, follow, and earn their spotlight.</strong> No algorithms you can't see. No credit cards.
          </p>
          <div className="hero-ctas">
            <Link href="/login" className="btn btn-primary btn-big">Drop Something →</Link>
            <Link href="/feed" className="btn btn-ghost btn-big">See the Feed</Link>
          </div>
      ...
      <footer>
        ...
        <div className="footer-copy">
          A platform proudly built in an afternoon by The Means of Production<br/>
